...
class Random {
  ...
  // Method to generate a random number with a circle-quarter-like ditribution
  double circle_quarter(double min, double max);

  // Method to generate a random integer in range (min, max)
  int randInt(int min, int max);
  // Method to generate a random bool;
  bool randBool();

  // Method to sample theta of a uniform distribution on the sphere
  double rand_theta();
  // Method to sample phi of a uniform distribution on the sphere
  double rand_phi();
};
